...
function ciniki_directory_entryImageDelete(&$ciniki) {
    ...
    $rc = ciniki_directory_checkAccess($ciniki, $args['tnid'], 'ciniki.directory.entryImageDelete'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    return ciniki_core_objectDelete($ciniki, $args['tnid'], 'ciniki.directory.entry_image', $args['entry_image_id'], $item['uuid'], 0x07);
}
?>
