...
function ciniki_directory_categoryHistory($ciniki) {
    ...
    $rc = ciniki_directory_checkAccess($ciniki, $args['tnid'], 'ciniki.directory.categoryHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }

    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'dbGetModuleHistory');
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.directory', 'ciniki_directory_history', $args['tnid'], 'ciniki_directory_categories', $args['category_id'], $args['field']);
}
?>
