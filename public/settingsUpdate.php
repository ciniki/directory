...
function ciniki_directory_settingsUpdate(&$ciniki) {
    ...
    $rc = ciniki_directory_checkAccess($ciniki, $args['business_id'], 'ciniki.directory.settingsUpdate'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    foreach($changelog_fields as $field) {
        if( isset($ciniki['request']['args'][$field]) ) {
            ...
            ciniki_core_dbAddModuleHistory($ciniki, 'ciniki.directory', 'ciniki_directory_history', $args['business_id'], 
