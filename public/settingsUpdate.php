...
// Description
// -----------
// This method will update one or more settings for the directory module.
//
// Info
// ----
// Status:          defined
...
// <rsp stat='ok' id='34' />
//
function ciniki_directory_settingsUpdate(&$ciniki) {
    //  
    ...
    $rc = ciniki_directory_checkAccess($ciniki, $args['tnid'], 'ciniki.directory.settingsUpdate'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    // Insert or update the entry in the ciniki_directory_settings table
    //
    foreach($changelog_fields as $field) {
        if( isset($ciniki['request']['args'][$field]) ) {
            ...
            ciniki_core_dbAddModuleHistory($ciniki, 'ciniki.directory', 'ciniki_directory_history', $args['tnid'], 
                2, 'ciniki_directory_settings', $field, 'detail_value', $ciniki['request']['args'][$field]);
