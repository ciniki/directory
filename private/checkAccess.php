...
function ciniki_directory_checkAccess(&$ciniki, $business_id, $method) {
    ...
    if( !isset($rc['ruleset']) ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.directory.2', 'msg'=>'No permissions granted'));
    }
    ...
    // By default fail
    //
    return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.directory.4', 'msg'=>'Access denied'));
}
?>
